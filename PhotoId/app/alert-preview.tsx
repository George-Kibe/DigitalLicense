...
const options = [
  {
    title: "Share my Photo ID",
    description: "Photo, Name, DoB, , Status, Expiry date, Address, Signature, Card number, Digital document expiry date",
    icon: <FontAwesome5 name="id-card" size={24} color="#FFF" />,
  },
  {
  ...
  },
  {
    ...
    icon: <MaterialIcons name="picture-as-pdf" size={24} color="white" />,
  },
];

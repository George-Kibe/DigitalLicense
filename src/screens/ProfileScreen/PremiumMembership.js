...
const PremiumMembership = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.topText}>A PREMIUM MEMBERSHIP ALLOWS YOU TO:</Text>
      <ImageBackground
        source={BasicImage}
        ...
        <View style={styles.topRighButton}>
          ...
          <Text style={styles.topRighButtonText}>$20</Text>
        ...
        <View style={styles.bottomView}>
          <Text style={styles.dollarText}>$20 a month</Text>
        ...
        <View style={styles.bottomRighButton}>
          <Text style={styles.bottomRighButtonText}>$25 paid Monthly</Text>
          <Text style={styles.bottomRighButtonText}>(for one year)</Text>
          <Text style={styles.bottomRighButtonText}>$300 Yearly</Text>
        </View>
      </ImageBackground>
    </View>
  );
